...
module FFMPEG
  describe Movie do
    describe "initializing" do
      ...
      context "given a movie with 2 audio tracks" do
        before(:all) do
          @movie = Movie.new("#{fixture_path}/movies/multi_audio_movie.mp4")
        end
        ...
        it "should assign audio properties to the properties of the first stream" do
          ...
          stream_overview = @movie.audio_streams[0][:stream_overview]
